...
[![Codecov test coverage](https://codecov.io/gh/jaytohe/ecostats-rshiny/branch/main/graph/badge.svg)](https://app.codecov.io/gh/jaytohe/ecostats-rshiny?branch=main)
<!-- badges: end -->
...
You can install the development version of vocomatcher from [GitHub](https://github.com/) with:
...
_Note: The example data is not real._
